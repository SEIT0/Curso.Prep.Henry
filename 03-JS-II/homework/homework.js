...
function fizzBuzz(numero) {
  ...
  if((numero % 3) === 0) {if(numero % 5 === 0) {return 'fizzbuzz'} return 'fizz'}
...
function operadoresLogicos(num1, num2, num3) {
  ...
  if(Math.max(num1, num2, num3) === num1) {return 'Número 1 es mayor y positivo'}
  if(Math.max(num1, num2, num3) === num3) {num3++; return num3}
  return false
}
...
function tablaDelSeis(){
  ...
  //Escribe tu código aquí   
  var t6 = [x0, x1, x2, x3, x4, x5, x6, x7, x8, x9, x10]
  x0 = 6 * 0;
  x1 = 6 * 1;
  x2 = 6 * 2;
  x3 = 6 * 3;
